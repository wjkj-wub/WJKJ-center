...
public class JuheTelCharge {
	...
	public static RequestConfig config = RequestConfig.custom().setConnectTimeout(30000).setSocketTimeout(30000)
			.build();
	public static final String key = "42264a1c53cded4c8e7f64768119bc07";//申请的接口Appkey
	...
	public static final String yueUrl = "http://op.juhe.cn/ofpay/mobile/yue?key=" + key + "×tamp=%&sign=$";
	...
	*/
	public static int telCheck(String phone, int cardnum) throws Exception {
		...
		error_code = object.getInteger("error_code");
		return error_code;
	}
	...
	*/
	public static String onlineOrder(String phone, int cardnum, String orderid) throws Exception {
		String result = null;
		//Md5Util工具类
		String sign = EncodeUtils.MD5(openId + key + phone + cardnum + orderid);
