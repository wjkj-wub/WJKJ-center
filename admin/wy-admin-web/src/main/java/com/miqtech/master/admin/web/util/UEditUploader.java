...
public class UEditUploader {
	...
	// 保存路径
	private String savePath = "uploads/imgs/UEditor";
	// 文件允许格式
		...
		try {
			...
			while (fii.hasNext()) {
				...
				if (!fis.isFormField()) {
					...
					// 又拍云处理
					File tmpFile = new File("tmp" + File.separator + savePath + this.originalName);
					FileUtils.copyInputStreamToFile(in, tmpFile);
					UpYunUploaderUtils.uploadImg(tmpFile, savePath, this.fileName);
	...
	private String getFolder(String path) {
		...
		String dirName = this.getPhysicalPath(path);
