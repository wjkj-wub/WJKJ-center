	...
	<body>
		...
		<div class="mb12">
			<form id="search" action="1" method="post">
				...
				<div class="mb12 col-md-12">
					<div class="col-md-4">
						<a class="btn btn-success" href="${ctx}/overActivity/subject/edit">新增</a>
					</div>
				</div>
			</form>
			...
			<#if list??>
				<#list list as o>
					<tr>
						...
						<td><#if (o.cover)??><img src="${imgServer!}${(o.cover)!}" style="width:50px;height:50px;" /></#if></td>
						<td>${(o.title)!}</td>
						<td>${(o.childrenCount)!}</td>
						...
						<td>
							<a type="button" class="btn btn-info" href="${ctx}/overActivity/subject/edit?id=${(o.id)!}">编辑</a>
							...
							<a type="button" class="btn btn-info" href="${ctx}/overActivity/list/3/1?pid=${(o.id)!}">前往新增</a>
						</td>
					</tr>
				</#list>
			</#if>
