			...
			<form class="form-horizontal" role="form" method="post">
				...
				<div class="form-group">
					<div class="col-md-offset-2 col-md-10">
						<a type="button" class="btn btn-info" href="${ctx}/thirdparty/cdkey/category/list/1"><i class="icon-angle-left"></i> 返回列表</a>
				...
				$form.find('#submit').on('click', function() {
					...
					if(formValid) {
						...
						$form.ajaxSubmit({
							...
							success : function(d) {
								if (d.code == 0) {
									window.location = '${ctx}/thirdparty/cdkey/category/list/1';
								} else {
									alert(d.result);
								}
							},
