...
(function () {
    ...
    var iframeUrlMap = {
       ...
       //'highlightcode':'~/dialogs/highlightcode/highlightcode.html',
        ...
        'cusimg':'~/dialogs/cusimg/cusimg.html'
    };
    ...
    var btnCmds = ['undo', 'redo', 'formatmatch',
        ...
        'deletecol', 'splittorows', 'splittocols', 'splittocells', 'mergecells', 'deletetable','cusimg'];
    ...
    var dialogBtns = {
        ...
        ok:['attachment', 'anchor', 'link', 'insertimage', 'map', 'gmap', 'insertframe', 'wordimage',
            'insertvideo', 'insertframe', 'edittip', 'edittable', 'edittd', 'scrawl', 'template', 'music', 'background','cusimg']
