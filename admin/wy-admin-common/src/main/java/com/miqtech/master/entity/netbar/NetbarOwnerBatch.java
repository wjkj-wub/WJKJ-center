 ...
 */
@Entity
@Table(name = "netbar_t_owner_batch")
public class NetbarOwnerBatch extends IdEntity {
	...
	private Date earliestDate;// 首笔交接班单的时间
	private Date latestDate;// 末笔交接班单的时间
	private String serNumbers;// 订单号
